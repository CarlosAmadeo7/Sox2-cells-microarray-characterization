...
2. Repository contains ouput from LIMMA workflow .R script:
   2.1 CTX_FullList: Full list of genes from microarray analysis ( either significant or not ) including protein-coding genes, microRNAs, etc. 
   2.2 FullList_protein_coding_genes: Genes( either significant or not) and exclusively "protein coding genes".
   2.3 CTX_DGE: protein-coding Differential Expressed genes. Cutoff is FDR < 0.05 and ABS(logFC > 1).
